#agent implememtation without facing action dynamic
#print the MDP after the drift, drift part, show the actual drift, where the reward much diff
#the episodic log , explain the result , also detail plot 
#compare 2 collection of episodes.. distinguish the random with the actual drift
#also check recover measure 
#wirte down the expment setting , do the systematiclly ,
...
class OptimalPolicyAgent:
    def __init__(self, env: TaskEnv_driftype):
        self.policy = None
...
class MetaDQNAgent:
    def __init__(self, env):
        ...
        self.memory = deque(maxlen=200) #online, so keep only small batch of memory
